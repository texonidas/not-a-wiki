...
<p>Realm Grinder was first published on May 19, 2015. Since then, there has been many expansions and updates - the game is constantly evolving.</p>
<p>Realm Grinder puts you in the role of a good or evil monarch, managing buildings, upgrades, and politics in order to create a large, powerful, and - most importantly - rich Realm.</a>
<p>The game belongs to the idle/incremental genre, meaning you will have to click (at least in the beginning), buy buildings and upgrades, cast spells and make other strategic choices with the ultimate goal of gaining more and more coins. There is no fixed end to the game, as you can always sell all your properties by abdicating to gain Gems, which will in turn help you generate even more coins. Abdications are one kind of soft reset, when you become even richer, you will be able to start a new life by Reincarnating, an other kind of soft reset that allows you to gain other bonuses that will further speed up your next life as monarch.
<p>Realm Grinder is the first of its kind to introduce a significant level of replayability by giving the player choices that will change their play style. You will be given goals and to reach these goals, the choice to join different factions of mythic creatures. Ranging from good Fairies, evil Goblins, to neutral Titans, each faction have their own resource (Faction Coins) obtained randomly by clicking the background. Each focuses on different mechanics, ranging from improving low tier buildings to massive spell-casting capabilities. As you play and learn, it will be yours to find out how to best reach these different goals.</p>
<p><img src="http://musicfamily.org/realm/Factions/picks/FactionGrid.png" usemap="#FactionGrid-map">

<map name="FactionGrid-map">
	<area href="http://musicfamily.org/realm/FairyFaction/" research="
<p><b>Fairy</b></p>
...
<p>Part of the Good Vanilla Factions, the Fairies can cheaply build the 3 first Tier buildings, thus boosting perks based on amount of buildings, and help get some of the building trophy series.</p>
<p>With their spell upgrade, they can magically multiply the amount of assistants, which combined with other perks can become a very strong asset.</p>
	" coords="4,4,58,58" shape="rect">
	<area href="http://musicfamily.org/realm/ElfFaction/" research="
<p><b>Elven</b></p>
...
<p>Part of the Good Vanilla Factions, the Elven Faction increase click reward and the chance to find faction coins.</p>
<p>They can help you to get the Click and Faction coins trophies series. Their spell upgrade will relieve you from the necessity of manual clicking and let you aim for the Treasure Trophies series while idling.</p>
	" coords="64,4,118,58" shape="rect">
	<area href="http://musicfamily.org/realm/AngelFaction/" research="
<p><b>Angel</b></p>
...
<p>Their Bloodline increases Mana Regeneration based on spells cast this game.</p>
	...
	<area href="http://musicfamily.org/realm/GoblinFaction/" research="
<p><b>Goblin</b></p>
<p>The sly Goblins excel at making the best possible deals and bargains.</p>
<p>Affiliating yourself with the Goblins faction will vastly increase the potential of your Tax Collection spell.</p>
<p>Part of the Evil Vanilla Factions, the Goblin's asset is the ability to empower the Tax collection spell, therefore boosting both their production and the production of Faction Coins.</p>
<p>Their Bloodline will be valuable when aiming for all the building trophy series.</p>
	" coords="184,4,238,58" shape="rect">
	<area href="http://musicfamily.org/realm/UndeadFaction/" research="
<p><b>Undead</b></p>
...
<p>Part of the Evil Vanilla Factions, the Undead become more powerful with time.</p>
<p>Their Heritage and Bloodline give assistants based on playtime and reincarnations and is more frequently used in late games.</p>
	" coords="244,4,298,58" shape="rect">
	<area href="http://musicfamily.org/realm/DemonFaction/" research="
<p><b>Demon</b></p>
...
<p>Part of the Evil Vanilla Factions, the Demons are related to increasing production of highest tier buildings and have perks based on the amount of trophies unlocked.</p>
<p>Their Bloodline boosts the production bonus of gems based on how much time you spent with the Evil alignment this reincarnation.</p>
	" coords="304,4,358,58" shape="rect">
	<area href="http://musicfamily.org/realm/TitanFaction/" research="
<p><b>Titan</b></p>
...
<p>Part of the Neutral Faction and the first Neutral Faction to be unlocked as the requirements are the lowest.</p>
<p>Both the Titans' Bloodline and Heritage boost your production based on how many Royal Exchanges you have purchased in this abdication.</p>
<p>Their Faction spell is based on luck and can become very powerful.</p>
	" coords="4,64,58,118" shape="rect">
	<area href="http://musicfamily.org/realm/DruidFaction/" research="
<p><b>Druid</b></p>
...
<p>Part of the Neutral Faction, the Druids feature a considerably nice Heritage that increases max mana, and their bloodline increase mana regeneration based on your max mana.</p>
<p>Their final Challenge reward extends their spell to affect more buildings.</p>
	" coords="64,64,118,118" shape="rect">
	<area href="http://musicfamily.org/realm/FacelessFaction/" research="
<p><b>Faceless</b></p>
<p>Little is known about the Faceless, but it is said they did not possess individual minds, instead they were all connected to a central consciousness which governed all their choices and behaviours.</p>
<p>Affiliating yourself to the Faceless Faction will boost your production based on your past choices while giving progressively better bonuses.</p>
<p>Part of the Neutral Faction, the Faceless feature perks that becomes stronger with time.</p>
<p>Their Heritage is based on the highest amount of buildings owned in the current reincarnation, and thus can easily be improved by doing a Goblin-line run.</p>
	" coords="124,64,178,118" shape="rect">
	<area href="http://musicfamily.org/realm/DwarfFaction/" research="
<p><b>Dwarven</b></p>
...
<p>The Dwarven faction cannot be combined with Evil or Neutral Factions, nor is there Research Tree for Dwarven.</p>
	...
	<area href="http://musicfamily.org/realm/DrowFaction/" research="
<p><b>Drow</b></p>
...
<p>The Drow faction cannot be combined with Good or Neutral Factions, nor is there Research Tree for Drow.</p>
	...
	<area href="http://musicfamily.org/realm/DragonFaction/" research="
<p><b>Dragon</b></p>
...
<p>The Dragon faction cannot be combined with Good or Evil. Unlocking the Dragon faction requires 46 Reincarnations and can be done by completing a series of quests.</p>
	...
	<area href="http://musicfamily.org/realm/ArchonFaction" research="
<p><b>Archon</b></p>
<p>The Archon value loyalty and any systematic and efficient plan of action.</p>
<p>Affiliating with them will increase your ability to boost your production immensely over long periods of time.</p>
	" coords="4,124,58,178" shape="rect">
	<area href="http://musicfamily.org/realm/DjinnFaction" research="
<p><b>Djinn</b></p>
<p>A magical race of ephemeral and elusive beings, unbound by natural rules but instead commanding them.</p>
<p>Affiliating with them will grant you the ability to manipulate random outcomes to your advantage.</p>
	" coords="64,124,118,178" shape="rect">
	<area href="http://musicfamily.org/realm/MakersFaction" research="
<p><b>Makers</b></p>
<p>The legendary old race which is said to have created the world, their watchful eye aims to keep all forces in check.</p>
<p>Affiliating with them will increase your ability to dominate all your resources.</p>
	" coords="124,124,178,178" shape="rect">
	<area href="http://musicfamily.org/realm/MercenaryFaction/" research="
<p><b>Mercenary</b></p>
<p>When a mercenary crosses your path, there's only one thing that can save your life: offer him more money than he can get by killing you.</p>
<p>If you gain the favor of the mercenaries, you will be able to combine the power of all races at once.</p>
<p>Available in all alignments, The Mercenaries can combine the power of the existing factions: Lets you choose 2 spells and 3x4 faction upgrades enabling you to create a custom cross-faction build.</p>
<p>Unlocking the Mercenaries Requires 3 reincarnations and can be done in different game plays.</p>
	" coords="184,124,238,178" shape="rect">
</map>
<!-- <?php include "musicfamily.org/../scripts/footer.html"; ?> -->
